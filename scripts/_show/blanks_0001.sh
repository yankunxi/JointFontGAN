...
EXE_PATH="${PROJECT_DIR}xifontgan/plot/show_paper_blanks.py"

{
python -u "${EXE_PATH}" --model "EskGAN_blanks=0.99" "EskGAN_blanks=0.85" "EskGAN" --blanks 0.99 0.85 0.7 --font "1980 portable.0.0" "advanced_led_board-7.0.0" \
