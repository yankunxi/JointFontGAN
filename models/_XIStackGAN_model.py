    ...
    def initialize(self, opt):
        ...
        if self.opt.conditional:
            ...
            if opt.which_model_preNet != 'none':
                self.preNet_A = XInetworks.define_preNet(self.opt.input_nc_1 + self.opt.output_nc_1, self.opt.input_nc_1 + self.opt.output_nc_1, which_model_preNet=opt.which_model_preNet, norm=opt.norm, gpu_ids=self.gpu_ids)
